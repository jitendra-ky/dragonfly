...
function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.detail || err.response?.data?.email?.[0] || 'Sign up failed. Please try again.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-8">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">Join Dragonfly to start chatting</p>
        </div>
        ...
        {/* OTP Modal */}
        <Modal isOpen={showOTPModal} onClose={() => setShowOTPModal(false)} title="Verify Your Email">
